...
@section('content')
    ...
    <div class="p-6 border-b border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row items-start sm:items-center justify-between">
        ...
        <div class="flex items-center gap-2 w-full sm:w-auto">
            <form action="{{ route('design-files.index') }}" method="GET" class="relative flex-grow sm:flex-grow-0">
                <input type="text" name="search" placeholder="Cari file desain..." value="{{ request('search') }}" class="pl-10 pr-4 py-2 w-full border border-slate-300 dark:border-slate-700 rounded-lg focus:ring-primary focus:border-primary dark:bg-slate-800 dark:text-white">
