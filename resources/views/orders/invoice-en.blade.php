...
@section('content')
    ...
    <div class="invoice-container bg-white shadow-lg rounded-lg">
        ...
        <div class="flex justify-between items-start border-b border-gray-300 pb-6 mb-8">
            <div>
                ...
                <p class="text-gray-600 text-sm">Jl. Kota Raja, Gn. Sari, Kec. Tj. Karang Pusat, Kota Bandar Lampung, Lampung
                    35127, Indonesia</p>
                <p class="text-gray-600 text-sm">Email: contact@rumahide88.com</p>
            </div>
            <div class="text-right">
                <p class="text-xl font-bold text-gray-700 mb-1">#{{ $order->order_number }}</p>
                <p class="text-sm text-gray-600">Order Date: <span
        ...
        <div class="mb-10">
            <h2 class="text-lg font-semibold text-gray-700 mb-3 border-b border-gray-200 pb-2">Bill To:</h2>
        ...
        <div class="w-full overflow-x-auto mb-10 border border-gray-200 rounded-lg">
            <table class="min-w-full text-left">
                <thead class="bg-gray-100">
                    <tr>
                        <th class="px-4 py-3 text-xs font-bold text-gray-600 uppercase tracking-wider">Product</th>
                        <th class="px-4 py-3 text-xs font-bold text-gray-600 uppercase tracking-wider text-center">Quantity
                        </th>
                        <th class="px-4 py-3 text-xs font-bold text-gray-600 uppercase tracking-wider text-center">Size</th>
                        <th class="px-4 py-3 text-xs font-bold text-gray-600 uppercase tracking-wider text-right">Unit Price
                        </th>
        ...
        <div class="flex justify-end mb-10">
            <div class="w-full max-w-sm">
                ...
                <div class="flex justify-between py-3 border-b-2 border-gray-400 text-xl">
                    <span class="text-gray-800 font-extrabold">Final Amount</span>
                ...
                <div class="flex justify-between py-3 mt-4 bg-blue-50 border-blue-200 border rounded-lg px-4">
                    <span class="text-blue-800 font-bold">Amount Due</span>
        ...
        <!-- Footer Section -->
        <div class="mt-12 text-center text-sm text-gray-500 border-t border-gray-300 pt-6">
