...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200"
    ...
    <div class="relative min-h-screen">
        ...
        <div class="flex flex-col items-center justify-center min-h-screen text-center px-6">
            <h1 class="text-8xl md:text-9xl font-bold text-indigo-500">419</h1>
            <h2 class="mt-4 text-2xl md:text-3xl font-semibold text-gray-800 dark:text-white">Halaman Kadaluarsa</h2>
            <p class="mt-2 text-gray-600 dark:text-gray-400">Silakan kembali dan coba lagi. Jika masalah berlanjut, muat ulang halaman.</p>
            <div class="mt-8">
                <a href="{{ url()->previous() }}"
